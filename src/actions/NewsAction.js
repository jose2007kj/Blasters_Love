...
export const saveNews = (news)=>{
    ...
    return async dispatch => {
        try {
            ...
            console.log("news not saved error is:"+error)
...
export const getSavedNews=()=>{
    // console.log("inside get saved news");
    return async dispatch=>{
        await AsyncStorage.getItem('news_cache').then((stored_news) => {
            // console.log("news from async"+stored_news);
            // console.log("json dtat "+JSON.parse(stored_news));
