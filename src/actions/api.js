...
export const SCHEDULE = BASE_URL.concat('feeds-schedule/?methodtype=3&client=8&sport=2&league=0&timezone=0530&language=en&tournament=india_sl_2018');
export const STANDING= BASE_URL.concat('sifeeds/repo/football/live/india_sl/json/115_standings.json');
export const SCHEDULE_DETAILS=BASE_URL.concat('sifeeds/repo/football/live/india_sl/json/');